<?php
    ...
    $hero = get_field('hero_banner', $page_id);
    $title = get_field('hero_title', $page_id);
    $desc = get_field('hero_description', $page_id);
    $wa = get_field('whatsapp_number', $page_id);
    $btn = get_field('button_text', $page_id);
?>

<?php if ($hero): ?>
    <section class="hero" id="home">
        <img src="<?php echo esc_url($hero); ?>" alt="Hero Banner">
        <div class="bg-shadow"></div>
        <div class="box-tagline">
            <h1><?php echo $title; ?></h1>
            <p><?php echo $desc; ?></p>
            <a target="_blank" href="https://wa.me/<?php echo $wa; ?>?text=Hi%20BaliRide%2C%20I%20want%20to%20rent%20a%20vehicle"
                class="btn-wa-head">
                <span>
